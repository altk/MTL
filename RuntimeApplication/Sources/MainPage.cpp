...
MainPage::MainPage() noexcept
{
	...
	MTL::ComPtr<ABI::Windows::UI::Xaml::Controls::IPage> page;
	VERIFY_SUCCEEDED(pageFactory->CreateInstance(static_cast<IPageOverrides *>(this), m_inner.GetAddressOf(), page.GetAddressOf()));
	...
	auto hr = appStatics->LoadComponentWithResourceLocation(reinterpret_cast<IDependencyObject *>(this), uri.Get(), ComponentResourceLocation::ComponentResourceLocation_Application);
	VERIFY_SUCCEEDED(hr);
}